...
(function () {
  ...
  function buildShell() {
    ...
    function addFramePadding(doc) {
      ...
      style.textContent = "html,body{overflow:hidden!important;min-height:0!important}body{padding-bottom:150px!important}@media(max-width:720px){body{padding-bottom:110px!important}}";
